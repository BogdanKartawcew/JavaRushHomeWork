    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                /*
                * ми порівнюємо і імя і дату.
                * сортировать нужно в алфавитном порядке, далее если в алфавитном порядке name одинаковы то сортируется по дате,
                 * далее если даты одинаковы, то сортируется по прибыли
                * */
                ...
                int compareNames = name1.compareTo(name2);
                int compareDates = formatter.format(date2).compareTo(formatter.format(date1));
                if (compareNames != 0) return compareNames;
                else if (compareDates != 0) return compareDates;
                else {
