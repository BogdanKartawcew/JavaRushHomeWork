...
public class Solution {
    ...
    {
        public static AtomicInteger pool = new AtomicInteger(0);
        public ThreadGroup threadGroup;
        public AtomicInteger threadNumber = new AtomicInteger(0);
        public AtomicInteger currentPoolNUmber;

        public AmigoThreadFactory()
        {
            currentPoolNUmber = new AtomicInteger(pool.incrementAndGet());
        ...
        public Thread newThread(Runnable r)
        {
            ...
            String name = String.format("%s-pool-%s-thread-%s", threadGroup.getName(), currentPoolNUmber, threadNumber);
