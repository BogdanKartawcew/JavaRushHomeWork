...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        Cache<SomeKey, SomeValue> cache1 = new Cache<>();
        cache1.put(value);

        SomeValue valueFromCacheExisted = cache1.getByKey(someKey, SomeValue.class);
        System.out.println(valueFromCacheExisted);

        SomeValue valueFromCacheNew = cache1.getByKey(someKeyNew, SomeValue.class);
