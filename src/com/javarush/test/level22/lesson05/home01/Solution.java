...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) {
        ...
        catch (Exception e)
        {
            ...
            else if (string == null && threadName.equals("SECOND_THREAD_NAME"))
                throw new TooShortStringSecondThreadException();
            else if (string == null) throw new RuntimeException();
        }
        return result;*/
        int firstIndex = 0;
        int lastIndex = 0;
        ...
        try {
            ...
            current = string.substring(firstIndex, lastIndex).trim(); // тут все зарішав трім. http://help.javarush.ru/questions/21295/level22-lesson05-home01
        } catch (Exception e) {
